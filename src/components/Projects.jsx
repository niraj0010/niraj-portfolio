...
const Projects = () => {
    const projects = [
        {
            id: 1,
            src: seluThrift,
            description: "Selu Thrift Store is a fully functional e-commerce site.",
        ...
        },
        {
            id: 2,
            src: catFeeder,
            description: "Automated Cat Feeder using IoT technology.",
        ...
        },
        {
            id: 3,
            src: eLibrary,
            description: "E-Library platform for digital book management.",
        ...
        },
        {
            id: 4,
            src: seluNsas,
            description: "NSAS-Nepalese Students Association at Southeastern.",
        ...
        },
        {
            id: 5,
            src: dipika,
            description: "Dipika - Personal Portfolio and Blog.",
    ...
    return (
        <div name="projects" className="bg-gradient-to-b from-black to-gray-800 w-full text-white min-h-screen">
